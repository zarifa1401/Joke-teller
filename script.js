...
function toggleButton(){
    //  if the button is true it will be false but if it is false the other side will be true
...
// function test(){
//     VoiceRSS.speech({
//         key: '315caca3553b4f42840f39bc594fc80b',
//         src: 'Hello, world!',
//         hl: 'en-us',
//         v: 'Linda',
//         r: 0, 
...
async function getJokes(){
    let joke = '';
    const apiUrl = 'https://v2.jokeapi.dev/joke/Programming,Miscellaneous?blacklistFlags=nsfw,religious,political,racist,sexist,explicit&type=single';
    try{
...
// getJokes();
//  event listeners, we make our button work when we click on it and it tell us a joke
